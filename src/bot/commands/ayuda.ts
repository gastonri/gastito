...
export const handleAyuda: CommandHandler = async ({ chatId, telegramClient }) => {
  await telegramClient.sendMessage(
    ...
    "*Gastito — comandos disponibles*\n\n" +
      "Mandá texto, una foto de ticket o un audio y el bot detecta automáticamente si es un gasto o un ingreso.\n\n" +
      "*Comandos*\n" +
      "`/ayuda` — muestra este mensaje\n" +
      "`/resumen` — gastos del mes agrupados por categoría\n" +
      "`/resumen <mes>` o `/resumen <mes> <año>` — resumen de un mes específico\n" +
      "`/grafico` — gráfico de barras con gasto diario y acumulado del mes actual (no acepta mes/año)\n" +
      ...
      "*Consejos*\n" +
      "• Podés mandar varios gastos y/o ingresos en un solo mensaje\n" +
      "• Las fotos de tickets se analizan automáticamente\n" +
      "• Los audios se transcriben antes de procesar\n" +
      "• Antes de tocar Confirmar podés mandar otro mensaje para corregir el registro pendiente (monto, categoría, etc.)\n" +
      "• Cada registro se manda con botones ✅ Confirmar / 🗑️ Cancelar"
  );
};
